...
void bresline1(int xa, int ya, int xb, int yb);//doc
void bresline2(int xa, int ya, int xb, int yb);//ngang
void bresline3(int xa, int ya, int xb, int yb);//0<m<=1
void bresline4(int xa, int ya, int xb, int yb);//-1<=m<0
void bresline5(int xa, int ya, int xb, int yb);//m>1
void bresline6(int xa, int ya, int xb, int yb);//m<-1
